...
@injectable()
export class TierFourGear extends GearGenerator {
    constructor(
        ...
        @inject("AndernTierFourWeapon")
        protected weaponGenerator: TierFourWeapon,
        ...
        this.logger.info("[Andern] Tier Four Bot Gear Generator enabled");
    }

    protected generateNightHeadwear(botInventory: PmcInventory): undefined {
        this.nightHeadwear.tierFourHeadwearWithNvg(botInventory);
    }
}
