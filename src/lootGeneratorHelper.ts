...
export function combineMapItemListIntoArray(
    selectedMapLootData: mapPmcBackpackLootData,
): string[][] {
    ...
    if (selectedMapLootData.include_normal_keys) {
        mapPmcBackpackLootTables[LootTableIndexs.COMMON].push(
            ...backpackLootConfig.loot_tables.common_keys,
        );
    }
